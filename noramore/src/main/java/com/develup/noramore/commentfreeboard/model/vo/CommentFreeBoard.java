...
public class CommentFreeBoard implements java.io.Serializable{
	...
	private static final long serialVersionUID = 6926003887570954515L;
    ...
    public CommentFreeBoard() {
		super();
	}

	public CommentFreeBoard(int boardId, int commentId, String memberId, String context, int refCommentId,
	...
	public String toString() {
		return "CommentFreeBoard [boardId=" + boardId + ", commentId=" + commentId + ", memberId=" + memberId
