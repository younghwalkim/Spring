...
<link rel="stylesheet" href="/getdrive/resources/css/chatbot.css">
</head>
<body>
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="chatbot-container">
        <div id="header">
            <h1>getDrive Helper</h1>
        </div>
        <div id="chatbot">
            <div id="conversation">
              <div class="chatbot-message">
                <p class="chatbot-text">안녕하세요. getDrive 도우미 입니다. <br>무엇을 도와드릴까요? </p>
              </div>
            </div>
            <form id="input-form">
              <message-container>
                <input id="input-field" type="text" placeholder="여기에 문의사항을 입력해주세요.">
                <button id="submit-button" type="submit">
                  <img class="send-icon" src="/getdrive/resources/images/send-message.png" alt="">
                </button>
              </message-container>                
            </form>
        </div>
...
<script src="/getdrive/resources/js/chatbot.js"></script>
