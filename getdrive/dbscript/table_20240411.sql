...
-- 2024.04.12 김영활 트리거 생성
DROP TRIGGER TRI_INSERT_MT_Search;
DROP TRIGGER TRI_DELETE_MT_Search;
DROP TRIGGER TRI_UPDATE_MT_Search;
DROP TRIGGER TRI_INSERT_BD_Search;
DROP TRIGGER TRI_DELETE_BD_Search;
DROP TRIGGER TRI_UPDATE_BD_Search;
DROP TRIGGER TRI_INSERT_CL_Search;
DROP TRIGGER TRI_UPDATE_CL_Search;
DROP TRIGGER TRI_DELETE_CL_Search;
